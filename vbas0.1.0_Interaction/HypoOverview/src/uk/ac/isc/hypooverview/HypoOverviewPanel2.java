 ...
 * this can be faster if a fixed scale of map adopted, but the user requires to change the scale
 * when the hypocentre move to high latitude (probably there is a way to make it quicker without compromising
 * the requirement)
 * @author hui
 */
public final class HypoOverviewPanel2 extends JPanel implements TileLoaderListener {
    ...
    private int yOffset;
    /**
     * rawMiniMap for the mini base map
     * miniMap labelled with current prime hypocentre
     */
    ...
    */
    ...
    /**
     * Flags to show different features, i.e. Seismicity, Mini Map, Hypocentres, reversed Seismicity, Border and force to fit all features
     */
    ...
    /**
     * Get the zoom level to fit all the seismicity
     * visible.
     */
    private void getZoomToFitSeis(double cenLat, double cenLon, double rangeDelta) {
        ...
        /**
         * make it in a detailed level instead of showing all the seismicity data
         */
