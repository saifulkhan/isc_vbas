...
public class TableWritetoHTML extends JPanel
    ...
    private void tableWriteToHTML() {

       MyTableModel model = (MyTableModel) table.getModel();

       try {
            File file = new File("C:\\Users\\saiful\\Downloads\\Additional\\table.html");
    ...
    private static void createAndShowGUI() throws IOException {
        ...
        TableWritetoHTML newContentPane = new TableWritetoHTML();
        newContentPane.setOpaque(true); //content panes must be opaque
        frame.setContentPane(newContentPane);

        newContentPane.tableWriteToHTML();
        newContentPane.tableWriteToHTML();
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(TableWritetoHTML.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
