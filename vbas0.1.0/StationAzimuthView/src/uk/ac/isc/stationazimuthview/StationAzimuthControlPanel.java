...
/**
 * Control panel for the station azimuth view, it set different scale level of the map and enable/disable the text of
 * presenting the number and percentage of phase from directions
 * @author hui
 */
