...
/**
 * This view is for showing the stations' distribution on the map and phase distributions on 
 * quantised directions. In addition, two curves shows the first and second azimuthal gap of the
 * event. Big gap from the collected stations indicates large uncertainty of the estimation.
 * 
 * @author hui
 */
