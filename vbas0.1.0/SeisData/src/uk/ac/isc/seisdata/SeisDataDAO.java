...
/**
 * This is the database access object which provides functions to read and write ISC database
 * @author hui
 */
...
//                        + " END ) DESC;";
    ...
    */
    ...
    /**
     * Get the phase number for the event control view so that it is know whether an event is big or not
     * @param evList
     * @return 
     */
    ...
    */
    ...
    /**
     * Retrieve all the phase ampmag and save them back to each phase in the list
     * @param evid
     * @param PhaseList
     * @return 
     */
