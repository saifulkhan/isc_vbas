...
public final class SeisUtils {
    ...
    /**
     * Give one coordinate, distance, and azimuth, calculate the latitude of the
     * other coordinate
     *
     * @param lat1
     * @param lon1
    ...
    /**
     * Give one coordinate, distance, and azimuth, calculate the longitude of
    ...
    /**
     * Utility function to caculate how many agencies adn stations reporting P,
     * S, PKP and pP type of phase.
     *
     * @param pList
     * @return
     */
