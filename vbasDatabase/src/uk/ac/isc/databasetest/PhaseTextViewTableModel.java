 ...
 * @author hui
 */
public class PhaseTextViewTableModel extends AbstractTableModel implements SeisDataChangeListener{

    private final String[] columnNames = {"Agency", "Code", "Time", 
    "Region Name","Delta. Deg.", "ES. Az.","Op. ID","ISC ID","ISC Res","Def.", "AmpMag", "Slowness", "SNR", "SE. Az.", "Phase ID", "Reading ID"};
    
    private final Class[] columns = new Class[]{String.class, String.class, String.class, String.class, Double.class, Double.class, 
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        else if(columnIndex == 5) //event to station azimuth
        {
        ...
        else if(columnIndex == 6) //reported phase type
        {
            retObject = phasesList.get(rowIndex).getOrigPhaseType();
        }
        else if(columnIndex == 7) //isc phase type
        {
            retObject = phasesList.get(rowIndex).getIscPhaseType();
        }
        else if(columnIndex == 8) //residual
        {   
        ...
        else if(columnIndex == 9) //defining or not
        {
